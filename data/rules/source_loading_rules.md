...
3. Проверен ли `knowledge_state` перед утверждениями NPC.
4. Не попал ли hidden lore в реплику персонажа.
5. Не пишет ли ИИ решение за Акиру.
6. Не подтянуты ли лишние персонажи.
7. Соответствует ли локация нужному canon-файлу.
