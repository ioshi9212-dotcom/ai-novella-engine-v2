...
def build_hard_rules(scene_id: str) -> list[str]:
    base_rules = [
        ...
        "Если предыдущий ответ ИИ ввёл неподтверждённый факт, не оправдывать его фразой 'логично драматически'. Нужно прямо считать это неканонной ошибкой и откатить/заменить на нейтральное развитие.",
        "Не создавать новые внешние силы, группы, команды, угрозы, маршруты, мотивы или связи без прямого разрешения файла сцены/state/hard_rules.",
        "Отец может защищать Акиру как взрослую дочь с амнезией, но Акире 25: не называть её ребёнком буквально и не писать как несовершеннолетнюю.",
        "Райден — командир 7 отряда Восточного сектора. Не писать, что связь Райдена с Восточным сектором не раскрыта.",
        "Основное имя персонажа — Райден. Не использовать Рэй, Рай или Рэйден как имя/алиас Райдена.",
        "Не писать, что Райден не знает Рэя. Корректно: Райден не знает Ирэя в start_scene и не ехал к дому Джуна по заранее полученному поручению."
    ]
